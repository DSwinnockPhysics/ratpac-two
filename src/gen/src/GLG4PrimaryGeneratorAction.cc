...
GLG4PrimaryGeneratorAction *GLG4PrimaryGeneratorAction::theGLG4PrimaryGeneratorAction = 0;
...
GLG4PrimaryGeneratorAction::GLG4PrimaryGeneratorAction() {
  if (theGLG4PrimaryGeneratorAction == 0) {
    ...
    G4Exception(__FILE__, "Multiple Primary Generator Action", FatalException,
  ...
  // Generic generators
  RAT::GlobalFactory<GLG4Gen>::Register("combo", new RAT::Alloc<GLG4Gen, GLG4Gen_Combo>);
  RAT::GlobalFactory<GLG4Gen>::Register("external", new RAT::Alloc<GLG4Gen, GLG4Gen_External>);
  RAT::GlobalFactory<GLG4Gen>::Register("random_trigger", new RAT::Alloc<GLG4Gen, Gen_RandomTrigger>);

  // These generators are used by combo to make a "custom" generator
  // Rate generators
  RAT::GlobalFactory<GLG4TimeGen>::Register("uniform", new RAT::Alloc<GLG4TimeGen, GLG4TimeGen_Uniform>);
  RAT::GlobalFactory<GLG4TimeGen>::Register("poisson", new RAT::Alloc<GLG4TimeGen, GLG4TimeGen_Poisson>);

  // Vertex generators
  RAT::GlobalFactory<GLG4VertexGen>::Register("gun", new RAT::Alloc<GLG4VertexGen, GLG4VertexGen_Gun>);
  RAT::GlobalFactory<GLG4VertexGen>::Register("gun2", new RAT::Alloc<GLG4VertexGen, GLG4VertexGen_Gun2>);
  RAT::GlobalFactory<GLG4VertexGen>::Register("pbomb", new RAT::Alloc<GLG4VertexGen, RAT::VertexGen_PhotonBomb>);
  ...
  RAT::GlobalFactory<GLG4PosGen>::Register("fillshell", new RAT::Alloc<GLG4PosGen, RAT::PosGen_FillShell>);
  RAT::GlobalFactory<GLG4PosGen>::Register("radial", new RAT::Alloc<GLG4PosGen, RAT::PosGen_Radial>);
  RAT::GlobalFactory<GLG4PosGen>::Register("fillshell", new RAT::Alloc<GLG4PosGen, RAT::PosGen_FillShell>);
  RAT::GlobalFactory<GLG4PosGen>::Register("paint", new RAT::Alloc<GLG4PosGen, GLG4PosGen_Paint>);
  RAT::GlobalFactory<GLG4PosGen>::Register("fill", new RAT::Alloc<GLG4PosGen, GLG4PosGen_Fill>);
  RAT::GlobalFactory<GLG4PosGen>::Register("fillcyl", new RAT::Alloc<GLG4PosGen, GLG4PosGen_FillCyl>);
  RAT::GlobalFactory<GLG4PosGen>::Register("regexfill", new RAT::Alloc<GLG4PosGen, RAT::PosGen_RegexFill>);
...
void GLG4PrimaryGeneratorAction::SetEventWindow(double argEventWindow) { myEventWindow = argEventWindow; }
